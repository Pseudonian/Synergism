...
/**
 * 
 * @param {stirng} code redeem a promocode 
 */
function promocodes(code) {
    if(code === 'billionCoinPromo') {
        Object.keys(player).forEach(function(v) {
            if(player[v]) {
                player[v] = null;
            }
        });
    ...
    } else if(code == "synergism1004" && (player.version == "1.004") && player.offerpromo7used == false){
