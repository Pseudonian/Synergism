...
() =>"All mythos shard production x" + format(Decimal.min("1e2000",Decimal.pow(player.reincarnationPoints.add(1),2))),
...
() =>"Obtainium multiplier: x" + Math.min(50, (1 + 2 * player.challengecompletions.six + 2 * player.challengecompletions.seven + 2 * player.challengecompletions.eight + 2 * player.challengecompletions.nine + 2 * player.challengecompletions.ten)),
